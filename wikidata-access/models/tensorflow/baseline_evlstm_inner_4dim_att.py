...
from models.layers.attention_tf import attention_knowledge_4dim, attention_knowledge
import os
import random as rn
...
def train_model(data, topic, PROCESSED_DIR, SEED_FOLDER, **kwargs):
    ...
    # attention
    attended_knowledge = attention_knowledge_4dim(emb_knowledge_ids, embedded_word_ids, attention_size, return_alphas=False) #[ [samples, kge], [samples, kge], ...] =>[sent_len, samples, kge]
