...
from keras.layers import Embedding, Bidirectional, Dropout, LSTM, Dense, TimeDistributed
...
def train_model(data, topic, PROCESSED_DIR, SEED_FOLDER, **kwargs):
    ...
    concat_sequences = tf.concat([bilstm_do, attended_knowledge], axis=2)  # the dimension where I want to add two tensors can be different, all others have to be equal
