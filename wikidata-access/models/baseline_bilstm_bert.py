...
import os
import numpy as np
from utils.helper import load_from_pickle, invert_dictionary
import tensorflow as tf
from models.layers.models_tf import DynamicBiRNN
from sklearn.metrics import f1_score
import random as rn
from helpers.data_generation.helper import convert_X_to_BERT
...
def train_model(data, topic, PROCESSED_DIR, SEED_FOLDER, **kwargs):
    ...
    sentence_input = Input(shape=(X_train.shape[1], bert_emb_size,), dtype='float32', name="text_input")

    bilstm_layer = Bidirectional(LSTM(lstm_size, recurrent_dropout=recurrent_dropout))(sentence_input)
